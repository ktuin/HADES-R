...
# input files
general_path = './'
station_file = 'data/inputs/EQ_DAS_stats_2.txt'
input_file = 'data/inputs/FORGE_picks_EQ.dat'
...
stations = [[station_names[channel_pairs[i][0]], station_names[channel_pairs[i][1]]] for i in range(100)] 
...
np.savetxt('./data/outputs/best_run_EQ_comb4_classic.csv', huge_locmat[:,:,best_run], delimiter=';')
np.savetxt('./data/outputs/allons_EQ_comb4_classic.csv', allons, delimiter=';')
np.savetxt('./data/outputs/allats_EQ_comb4_classic.csv', allats, delimiter=';')
np.savetxt('./data/outputs/aldeps_EQ_comb4_classic.csv', alldeps, delimiter=';')
np.savetxt('./data/outputs/master_evt_EQ_comb4_classic.csv', huge_locmat[ref,:,0], delimiter=';')
# np.savetxt('./data/outputs/truth_lon_EQ_comb4_classic.csv', cluster[:,0], delimiter=';')
# np.savetxt('./data/outputs/truth_lat_EQ_comb4_classic.csv', cluster[:,1], delimiter=';')
# np.savetxt('./data/outputs/truth_dep_EQ_comb4_classic.csv', cluster[:,2], delimiter=';')
np.savetxt('./data/outputs/iie_total_EQ_comb4_classic.csv', iie_total, delimiter=';')
...
# AX1 -------------------------------------------------------------------------
fig.suptitle(f"FORGE 2019 Earthquake results: Classic HADES, combination 3", fontsize=15)
ax1.set_aspect("equal")

h,_,_,im=ax1.hist2d(allons, allats, bins=bins, cmin=1, cmap=cmap, vmin=0, vmax=100, range=([336000,338000], [4.2600e6,4.2620e6]))
ax1.scatter(cluster_comp[ref,0], cluster_comp[ref,1], s=75, edgecolor='orange', facecolor='yellow', label='Reference event', zorder=20)
...
ax1.set_xlabel("Lon UTM [m]", fontsize=12)
ax1.set_ylabel("Lat UTM [m]", fontsize=12)
...
bb,_,_,im=ax2.hist2d(allons, alldeps, bins=bins, cmin=1, cmap=cmap, vmin=0, vmax=100, range=([336000,338000], [0,2000]))
...
ax2.scatter(cluster_comp[ref,0], cluster_comp[ref,2], s=75, edgecolor='orange', facecolor='yellow', label='Reference event', zorder=20)
...
ax2.invert_yaxis()
ax2.set_xlabel("Lon UTM [m]", fontsize=12)
...
aa,_,_,im=ax3.hist2d(allats, alldeps, bins=bins, cmin=1,cmap=cmap, vmax=100, range=([4.2600e6,4.2620e6], [0,2000]),
 vmin=0)
# ax3.scatter(cluster[:,1], cluster[:,2], marker='o', facecolor='None', edgecolor='k')
ax3.scatter(cluster_comp[ref,1], cluster_comp[ref,2], s=75, edgecolor='orange', facecolor='yellow', label='Reference event', zorder=20)
...
ax3.grid()
ax3.set_ylim(2250,0)
ax3.set_xlabel("Lat UTM [m]", fontsize=12)
ax3.set_ylabel("Depth [m]", fontsize=12)
# -----------------------------------------------------------------------------

fig.tight_layout(pad=0.5)
plt.savefig('./data/images/test_EQ_comb4_classic.png',dpi=300)
...
plt.legend()
plt.colorbar(im)
plt.savefig('./data/images/refined_EQ_comb4_classic.png', dpi=300)
#plt.show()

np.savetxt('./data/outputs/refined_EQ_comb4_classic.csv', cluster_comp_refine, delimiter=';')
